...
| **🛡️ 數據中心 NAS (CPU)** | 192.60.1.114 | 算力備援 / 數據存儲 | **33 TPS** (llama3.2:1b) |
...
| **🛡️ Fortinet 設備 (1)** | 192.60.1.102 | 安全防火牆 / VPN | FortiOS |
| **🛡️ Fortinet 設備 (2)** | 192.60.1.117 | 安全防火牆 / VPN | FortiOS |
